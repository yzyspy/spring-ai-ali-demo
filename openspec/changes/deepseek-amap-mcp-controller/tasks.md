...
- [ ] 4.1 编写单元测试验证 Controller 端点映射
- [ ] 4.2 编写集成测试验证 MCP 工具调用（Mock MCP Server）
...
- [ ] 5.1 更新 README.md，添加高德地图 MCP 集成说明
- [ ] 5.2 编写运行指南，说明如何配置和启动 MCP Server
- [ ] 5.3 添加 API 使用示例和请求/响应示例
- [ ] 5.4 记录已知问题和注意事项
